    ...
    def start_game(self):
        ...
        while len(self.called_numbers) < 6:
            ...
            if number is not None:
                ...
                print(f"Remaining Numbers: {6 - len(self.called_numbers)}\n")
                time.sleep(1)
            else:
